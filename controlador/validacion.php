		...
		<main class="row">
			<?php
				if(isset($_POST['enviar'] ) && $_SERVER["REQUEST_METHOD"]=="POST"){
					...
					elseif ($correo == 'chelitoquiroga@instituto.com' &&  $pass == 'sistemaNoche' || $correo == 'chelitosubsede@instituto.com'  && $pass == 'sistemaPenal123') 
					{
						header('Location: ../vista/public/resultado1.php?user=$correo&pass=$pass');
					}
						else{ 
