						...
						<div class="card border-white border border-4" style="border-radius: 1rem;">
							<div class="row g-0">
								<div class="col-md-6 col-lg-5 d-none d-md-block">
									<img src="HD-wallpaper-anakin-dark-side-anakin-skywalker-darth-vader-luke-rey-rise-of-skywalker-skywalker-star-wars-starwars-vader.jpg" alt="login form" class="img-fluid" style="border-radius: 0.7rem 0 0 0.7rem; height: 50rem; width: 50rem;">
								</div>
								<div class="col-md-6 col-lg-7 d-flex align-items-center bg-dark bg-opacity-50">
